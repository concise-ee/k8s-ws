...
from public internet (i.e. using your browser or curl). The full url should look like `http://35.205.242.187.nip.io/my-name/actuator/health`
...
3. Open browser `http://localhost:8089` and specify 100 users, 10 seconds and your public url in the host such as `http://35.205.242.187.nip.io/my-name/actuator/health`
